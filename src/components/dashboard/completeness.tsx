  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
      <div className="mb-1 flex items-center gap-2">
        ...
        <h2 className="font-semibold text-slate-800">Data completeness</h2>
      </div>

      <p className="mb-6 ml-9 text-sm text-slate-400">
          ...
          return (
            <div key={item.label}>
              ...
              <div className="h-3 overflow-hidden rounded-full bg-slate-100">
                <div
                  className={`h-3 rounded-full bg-linear-to-r ${barColor} transition-all duration-700`}
