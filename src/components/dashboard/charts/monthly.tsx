  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 dark:border-slate-800 dark:bg-slate-900">
      <div className="mb-1 flex items-center gap-2">
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-linear-to-br from-indigo-500 to-cyan-500 shadow-sm shadow-indigo-500/20">
      ...
      <div className="mb-4 ml-9 flex items-center gap-6">
        ...
        <span className="flex items-center gap-2 text-xs text-slate-400 dark:text-slate-500">
          <span className="h-2.5 w-5 rounded-full bg-slate-300 dark:bg-slate-700" />
          Previous year
        </span>
      </div>
